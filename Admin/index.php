          ...
          <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row mb-4">
              <div class="col-md-7">
                ...
                <div>
                  <a href="Product.php" class="btn btn-white btn-outline-white py-3 px-5 rounded-0 mb-lg-0 mb-2 d-block d-sm-inline-block">View Toys</a>
                  <a href="Feedback.php" class="btn btn-white py-3 px-5 rounded-0 d-block d-sm-inline-block">View Feedback</a>
                </div>
              </div>
            </div>
          </div>
